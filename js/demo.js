...
export const DEMO_CONFIG = {
  ...
  scenes: {
    1: [
      ...
      { name: 'Bass 2',      volume: 0.0, pan: -0.1, muted: false  },
      { name: 'Synth',       volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Synth 2',     volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Snare Roll',  volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Ride Cymbal', volume: 0.0, pan: -0.3, muted: false  },
      { name: 'SFX 1',       volume: 0.3, pan:  0.8, muted: false  },
      { name: 'SFX 2',       volume: 0.3, pan: -0.5, muted: false  },
    ...
    2: [
      ...
      { name: 'Bass 2',      volume: 0.0, pan: -0.1, muted: false  },
      { name: 'Synth',       volume: 0.2, pan:  0.3, muted: false  },
      { name: 'Synth 2',     volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Snare Roll',  volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Ride Cymbal', volume: 0.0, pan: -0.3, muted: false  },
    ...
    4: [
      ...
      { name: 'Bass',        volume: 0.9, pan: -0.1, muted: false  },
      { name: 'Bass 2',      volume: 0.0, pan: -0.1, muted: false  },
      { name: 'Synth',       volume: 0.8, pan:  0.3, muted: false  },
      { name: 'Synth 2',     volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Snare Roll',  volume: 0.0, pan:  0.3, muted: false  },
    ...
    5: [
      ...
      { name: 'Snare',       volume: 0.3, pan:  0.6, muted: false  },
      { name: 'Clap',        volume: 0.3, pan: -0.6, muted: false  },
      { name: 'Bass',        volume: 0.0, pan: -0.1, muted: false  },
      { name: 'Bass 2',      volume: 0.9, pan: -0.1, muted: false  },
      { name: 'Synth',       volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Synth 2',     volume: 0.8, pan:  0.3, muted: false  },
      { name: 'Snare Roll',  volume: 0.0, pan:  0.3, muted: false  },
      { name: 'Ride Cymbal', volume: 0.7, pan: -0.3, muted: false  },
      { name: 'SFX 1',       volume: 0.0, pan:  0.8, muted: false  },
      { name: 'SFX 2',       volume: 0.3, pan: -0.5, muted: false  },
    ...
    7: [
      ...
      { name: 'SFX 1',       volume: 0.4, pan:  0.8, muted: false  },
      { name: 'SFX 2',       volume: 0.3, pan: -0.5, muted: false  },
      { name: 'SFX 3',       volume: 0.3, pan:  0.5, muted: false  },
      { name: 'SFX 4',       volume: 0.3, pan: -0.8, muted: false  },
    ],
    ...
    9: [
      ...
      { name: 'Hi-hat',      volume: 0.0, pan:  0.1, muted: false  },
      { name: 'Snare',       volume: 0.0, pan:  0.6, muted: false  },
      { name: 'Clap',        volume: 0.2, pan: -0.6, muted: false  },
      { name: 'Bass',        volume: 0.9, pan: -0.1, muted: false  },
      { name: 'Bass 2',      volume: 0.0, pan: -0.1, muted: false  },
      { name: 'Synth',       volume: 0.8, pan:  0.3, muted: false  },
      { name: 'Synth 2',     volume: 0.0, pan:  0.3, muted: false  },
